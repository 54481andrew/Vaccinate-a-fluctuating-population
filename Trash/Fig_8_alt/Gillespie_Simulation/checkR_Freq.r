...
parmat$pmu <- 1 # Infected individuals die
...
##Big Picture
    ...
    plot(S~time, out, xlim = c(0,endtime), ylim = c(0,1000), type = 'l', lwd = 1)
...
#########################
    ...
    par(mai = c(1,1,0.1,0.1))
    plot(S~time, out, xlim = c(0,endtime), ylim = c(0,100), type = 'l', lwd = 1)
    lines(Iv~time, out, col = 'green', lty = 1, lwd = 1)
    lines(Ip~time, out, col = 'red', lty = 1, lwd = 1)
    lines(V~time, out, col = 'blue', lty = 1, lwd = 1)
    lines(P~time, out, col = 'pink', lty = 1, lwd = 1)
...
filename = paste("Data/Badger_Base", "/Par_", 0, sep = '')
...
##Big Picture
    ...
    par(mai = c(1,1,0.1,0.1))
    plot(S~time, out.base, xlim = c(0,endtime), ylim = c(0,1000), type = 'l', lwd = 1)
    lines(Iv~time, out.base, col = 'green', lty = 1, lwd = 1)
    ...
    points(Iv~time, dat.base[these,], col = 'green', cex = 0.25, pch = 1)
...
#########################
    ...
    par(mai = c(1,1,0.1,0.1))
    plot(S~time, out.base, xlim = c(0,endtime), ylim = c(0,100), type = 'l', lwd = 1)
    lines(Iv~time, out.base, col = 'green', lty = 1, lwd = 1)
    lines(Ip~time, out.base, col = 'red', lty = 1, lwd = 1)
    lines(V~time, out.base, col = 'blue', lty = 1, lwd = 1)
    lines(P~time, out.base, col = 'pink', lty = 1, lwd = 1)
