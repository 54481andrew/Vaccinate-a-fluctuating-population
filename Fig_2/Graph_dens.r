...
for(type in c('.png')){
    fn <- paste('Figure_2_DensDep_',type, sep='')
...
mtext(side = 2, text = 'Average V Abundance', line = 2.25, outer = FALSE, cex = 0.7)
...
###Axis labels
    ...
    if(i.f==1){
        legendtext = rev(c('225 Days', '1 Yr', '2.5 Yrs', '5 Yrs', '10 Yrs'))
