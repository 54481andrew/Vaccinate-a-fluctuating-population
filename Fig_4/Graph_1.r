...
for(ii in 1:nrow(gridvals)){
    ...
    setEPS()
    postscript(file = fn, height = 6, width = 6)
    layout(matrix(c(1,2,3,4), nrow = 2, ncol = 2, byrow = FALSE), widths = c(0.5,0.5,0.5,0.5),
    ...
    for(i.f1 in 1:nFVals1){
        for(i.f2 in 1:nFVals2){
            ...
            if(i.f2==1){
                ...
                text(x = 180, y = 1, labels = ifelse(parmat$type[wi] == 'f' , 'Frequency-Dependent',
                                                 'Density-Dependent'))
            ...
            if(i.f1==1 & i.f2==1){
                ...
                legend(x = -5, y = 0.8, legend = legendtext, col = c(col1,col2),
                       lwd = 2, bty = 'n', cex = 0.7,
                ...
                legend(x = 0.55*365, y = 0.8, legend = legendtext, col = 'black',
